...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <p class="lead">This website has been modified to add this line and automatically built by Jenkins</p>
      <p class="lead">This is a new line to test automatic build in Lab 6, Docker</p>
      <hr class="my-4">
